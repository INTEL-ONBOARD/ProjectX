    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center gap-6 select-none">
                ...
                >
                    <span className="text-3xl font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>Project M.</span>
                    <span className="text-sm font-normal tracking-wide" style={{ color: 'var(--text-muted)' }}>Manage smarter. Deliver faster.</span>
                </motion.div>
            </div>
            <motion.div
            ...
            >
                <div className="w-48 h-[2px] rounded-full overflow-hidden" style={{ background: 'var(--border-subtle)' }}>
                    <motion.div
...
const Root: React.FC = () => {
    ...
    // 4. Main app (with syncing overlay on first load + reconnecting overlay when DB drops)
    return (
        <>
            <MainApp />
            <BugReportModal />
